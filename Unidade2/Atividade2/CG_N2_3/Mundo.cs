...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      Objeto srPalito = null;

      #region Atividade 3
      // Quadrado com diagonal 0,5 tem lado aproximado de 0,35.
      srPalito = new SegReta(null, new Ponto4D(), new Ponto4D(0.35, 0.35));
      ObjetoNovo(srPalito); srPalito = null;
      #endregion
