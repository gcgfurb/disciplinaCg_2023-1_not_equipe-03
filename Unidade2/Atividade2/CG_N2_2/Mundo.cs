    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      if (input.IsKeyPressed(Keys.Space)) {
          ...
          switch(objetoSelecionado.PrimitivaTipo) {
              case PrimitiveType.Points: objetoSelecionado.PrimitivaTipo = PrimitiveType.Lines;
                  break;
              case PrimitiveType.Lines: objetoSelecionado.PrimitivaTipo = PrimitiveType.LineLoop;
                  break;
              case PrimitiveType.LineLoop: objetoSelecionado.PrimitivaTipo = PrimitiveType.LineStrip;
                  break;
              case PrimitiveType.LineStrip: objetoSelecionado.PrimitivaTipo = PrimitiveType.Triangles;
                  break;
              case PrimitiveType.Triangles: objetoSelecionado.PrimitivaTipo = PrimitiveType.TriangleStrip;
                  break;
              case PrimitiveType.TriangleStrip: objetoSelecionado.PrimitivaTipo = PrimitiveType.TriangleFan;
                  break;
              case PrimitiveType.TriangleFan: objetoSelecionado.PrimitivaTipo = PrimitiveType.Points;
                  break;
          }
      }
